                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-lg aspect-square overflow-hidden" ref={emblaRef}>
                            <div className="flex h-full">
                                {allImages.length > 0 ? (
                                    ...
                                    <div
                                        className="flex-[0_0_100%] flex items-center justify-center text-muted-foreground">
                                        No image
                                    </div>
                                )}
                            </div>
                            ...
                            <BreadcrumbList className="text-xs text-muted-foreground">
                                ...
                                <BreadcrumbItem>
                                    {product.categories?.name ? (
                                        <BreadcrumbLink asChild>
                                            <Link
                                                to={`/shop?category=${product.category_id}`}>{product.categories.name}</Link>
                                        </BreadcrumbLink>
                                    ) : (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border rounded-lg p-4 bg-white">
                            <h3 className="font-semibold mb-3 text-sm">Have question about this product? please
                                call</h3>
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    <Button variant="outline" size="sm"
                                            className="ml-2 h-7 text-xs border-red-500 text-red-500 hover:bg-red-50">
                                        Bkash Personal
                                    </Button>
                                </div>
                                <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {product.size_chart && Array.isArray(product.size_chart) && product.size_chart.length > 0 && (
                                <div className="mt-6">
                                    ...
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <span
                                            className="text-sm">Size Available: {product.sizes && Array.isArray(product.sizes) ? (product.sizes as string[]).join(", ") : "N/A"}</span>
                                    </div>
